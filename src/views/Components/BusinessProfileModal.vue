  ...
  >
    <div class="bg-white w-full max-w-lg rounded-2xl shadow-2xl p-8 border border-slate-100">
      <div class="mb-6">
        ...
        <p class="text-slate-500 text-sm mt-1">Sistemi kullanmaya başlamadan önce fatura ve raporlamalar için işletme detaylarınızı girmelisiniz.</p>
      </div>
...
// Kendi görünürlüğünü kendi yönetecek
...
const API_URL = 'http://31.210.36.10:5000/api/businessprofile';
