      ...
      <form @submit.prevent="handleSubmit" class="p-6 space-y-4">
        <div>
          ...
          <input 
            ...
            type="text" required :disabled="isLoading" placeholder="Ürün adı giriniz..." 
        ...
        <div>
          ...
          <div class="relative w-full">
            ...
            <div v-if="isDropdownOpen" class="absolute top-full left-0 mt-1 w-full bg-white border border-slate-200 rounded-xl shadow-xl z-50 p-2 space-y-2 max-h-60 flex flex-col">
        ...
        <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate-100 mt-6">
          ...
          <button type="submit" :disabled="isLoading" class="px-5 py-2.5 rounded-xl text-sm font-medium bg-amber-500 hover:bg-amber-600 text-white shadow-sm transition-colors flex items-center gap-1 disabled:opacity-60">
